...
-- Dumping data for table db_rental.booking: ~0 rows (approximately)
...
-- Dumping data for table db_rental.mobil: ~0 rows (approximately)
INSERT INTO `mobil` (`id_mobil`, `no_plat`, `merk`, `harga`, `deskripsi`, `tipe`, `status`, `gambar`) VALUES
	(1, 'N 3423 BHU', 'Mitsubishi', 750000, 'Detail bisa cek di google', 'Truk', 'Tersedia', '1719196299.webp');
...
-- Dumping data for table db_rental.pembayaran: ~0 rows (approximately)
